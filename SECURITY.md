...
- API keys are stored in your local Tauri userData directory
- No data is transmitted to third parties except AI providers (for AI processing)
...
- Keys are encrypted at rest by Tauri's secure storage

### Audio Processing

- Audio is processed in real-time and not stored
- Audio data is only sent to AI providers for transcription and processing
- No audio data is saved to disk
- Audio processing happens locally before transmission (when using local mode)

### Network Security

- All API communications use HTTPS
- No unencrypted data transmission
- API keys are sent securely to AI providers
...
Thank you for helping keep Winky secure! 🔒
